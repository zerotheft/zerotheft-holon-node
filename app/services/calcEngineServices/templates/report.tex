...
\trimbox{0 -15px 0 0}{ 
  \begin{tikzpicture}
      ...
      \node[rightHeaderText, below=of country, below=5px] (holon) {--holonUrl--};
...
\trimbox{0 -15px 0 0}{ 
  \begin{tikzpicture}
    ...
    \node[fullWidth, below =0pxof leadingProposal] (viewProposalTextLink) {\hypertarget{http://holon7.zerotheft.net/path/USA/issue/corp_tax_evasion}{View Full Proposal Text}};
    \node[fullWidth, below =0pxof viewProposalTextLink] (leadingProposalTitle) {\large \textbf{Proposal ID --leadingProposalID-- by --leadingProposalAuthor-- on --leadingProposalDate--}};
  \end{tikzpicture}
}
