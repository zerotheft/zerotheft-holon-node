...
\trimbox{0 -40pt 0 0}{
  \begin{tikzpicture}[scale=1.5, transform shape]
    ...
    \node[below=-4pt of noOfVoters, isTheftBlock] (votedYes) {\scriptsize Voted Yes: --yesVotes--};
    \node[below=-4pt of votedYes, isTheftBlock] (votedNo) {\scriptsize Voted No: --noVotes--};
    
    \node[yshift=-40pt, left=-120pt of votedNo] (noVoteImage) {\includegraphics[width=115pt]{--yesNoChart--}};
  \end{tikzpicture}
}
