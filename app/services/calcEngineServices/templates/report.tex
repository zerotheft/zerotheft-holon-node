...
\trimbox{0 -20pt 0 0}{
  \begin{tikzpicture}
    ...
    % \node[yshift=-40pt, right=0pt of isTheft] (noVoteImage) {\includegraphics[width=130pt]{/Volumes/WorkSpace/WhiteHat/zerotheft/zerotheft-holon-node/zt_report/reports/ztReport/USA-tax-corp_tax_evasion-yesNo.png}};
    \node[yshift=-70pt, left=-185pt of votedNo] (noVoteImage) {\includegraphics[width=130pt]{--yesNoChart--}};
  \end{tikzpicture}
}
% yesNoBlockEnd
...
\trimbox{0 15pt 0 0}{
  \begin{tikzpicture}
    % \node[] (theftValueChart) {\includegraphics[width=245pt]{/Volumes/WorkSpace/WhiteHat/zerotheft/zerotheft-holon-node/zt_report/reports/ztReport/USA-tax-corp_tax_evasion-votesForTheftAmount.png}};
...
{\renewcommand{\arraystretch}{2}% for the vertical padding
  \begin{longtable}{p{15pt} p{30pt} p{15pt} p{30pt} p{15pt} p{30pt} p{0pt} p{15pt} p{30pt} p{15pt} p{30pt} p{15pt} p{30pt}} 
