...
\trimbox{0 -40pt 0 0}{
  \begin{tikzpicture}
    ...
    \addplot[
      ...
      every node near coord/.append style={below right, rotate=35, shift={(2pt, 8pt)}},
...
\trimbox{0 -15pt 0 0}{ 
  \begin{tikzpicture}
    ...
    \node[fullWidth, below =0ptof leadingProposal] (viewProposalTextLink) {\href{http://holon7.zerotheft.net/path/USA/issue/corp_tax_evasion}{\color{blue}View Full Proposal Text}};
