...
\trimbox{0 10pt 0 0}{ 
  \begin{tikzpicture}
    ...
    \node[fullWidth, below =0ptof viewProposalTextLink] (leadingProposalTitle) {\large \textbf{Proposal by --leadingProposalAuthor-- on --leadingProposalDate-- asfsaf saf asf afsdf asd fasdf as asdf asd fasdf asdf as f asfasdf adf asdf asf}};
  \end{tikzpicture}
}
