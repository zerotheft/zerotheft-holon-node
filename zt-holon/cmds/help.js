const menus = {
  main: `
    ...
    update-holon-status  --owner_address <holon_address> --status <holon_status>      ... update holon status by holon owner in the blockchain
...
`,
  ...
  'update-holon-status': `zt-holon update-holon-status --owner_address <holon_address> --status <holon_status>            ... Update holon status by holon owner in the blockchain
  `,
}
